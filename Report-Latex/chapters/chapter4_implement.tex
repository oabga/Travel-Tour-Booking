...
\subsection{Kịch bản kiểm thử API với Postman}\label{sub4.5.1}
...
\begin{figure}[H]
  ...
  \framebox[14cm][c]{\rule{0pt}{6cm} [Chèn screenshot Postman: Đặt tour \& Thanh toán]}
...
\begin{figure}[H]
  \centering
  \framebox[14cm][c]{\rule{0pt}{6cm} [Chèn screenshot Postman: Review/Cancel/History]}
  % \includegraphics[width=\textwidth]{image/postman/step5_after.png}
  \caption{Postman --- Bước 5: Đánh giá, hủy và lịch sử booking}\label{fig:pm_after}
\end{figure}
...
\begin{figure}[H]
  \centering
  \framebox[14cm][c]{\rule{0pt}{6cm} [Chèn screenshot Postman: Báo cáo Admin]}
  % \includegraphics[width=\textwidth]{image/postman/step6_reports.png}
