    ...
    var xDoc = new XDocument(
        ...
        new XElement("Tours",
            tours.Select(t => new XElement("Tour",
                new XElement("TourId",       t.TourId),
                new XElement("Name",         t.Name),
                new XElement("Category",     t.Category.CategoryName),
                new XElement("Destination",  t.Destination.DestinationName),
                new XElement("PricePerPerson",
                    t.PricePerPerson.ToString("F2")),
                new XElement("DurationDays", t.DurationDays),
                new XElement("Description",
                    t.Description ?? string.Empty),
                new XElement("CreatedAt",
...
// XmlService.cs
public async Task<int> ImportToursFromXmlAsync(string xmlContent)
{
    var xDoc     = XDocument.Parse(xmlContent);
    var elements = xDoc.Root!.Elements("Tour");

    var dtoList = elements.Select(e => new CreateTourDto
    {
        Name            = (string)e.Element("Name")!,
        CategoryName    = (string)e.Element("Category")!,
        DestinationName = (string)e.Element("Destination")!,
        PricePerPerson  = decimal.Parse(
                              (string)e.Element("PricePerPerson")!),
        DurationDays    = int.Parse(
                              (string)e.Element("DurationDays")!),
    ...
    return count;   // Trả về số tour đã nhập thành công
}
\end{lstlisting}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{image/postman/get_data/categories.png} \\[2ex]
  \includegraphics[width=0.8\textwidth]{image/postman/get_data/tours_popular.png}
...
\begin{figure}[H]
  \centering
  % Tạm thời dùng framebox tạo chỗ trống. Khi có ảnh thật, bạn comment dòng framebox lại và dùng includegraphics.
  \includegraphics[width=0.8\textwidth]{image/postman/booking_payment/post_booking.png} \\[2ex]
  \includegraphics[width=0.8\textwidth]{image/postman/booking_payment/get_booking_id.png} \\[2ex]
  \includegraphics[width=0.8\textwidth]{image/postman/booking_payment/post_payment.png} \\[2ex]
  \includegraphics[width=0.8\textwidth]{image/postman/booking_payment/get_total_paid.png} \\[2ex]
  \includegraphics[width=0.8\textwidth]{image/postman/booking_payment/get_remaining.png} \\[2ex]
  % \includegraphics[width=\textwidth]{image/postman/step4_booking.png}
  \caption{Postman --- Bước 4: Đặt tour và Thanh toán}\label{fig:pm_booking}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{image/postman/reports/get_revenue.png} \\[2ex]
  \includegraphics[width=\textwidth]{image/postman/reports/get_revenue_monthly.png} \\[2ex]
  \includegraphics[width=\textwidth]{image/postman/reports/get_popular_tours.png} \\[2ex]
  \includegraphics[width=\textwidth]{image/postman/reports/get_occupancy.png} \\[2ex]
  \caption{Postman --- Bước 6: Trích xuất báo cáo thống kê}\label{fig:pm_reports}
\end{figure}
